...
class CardTest {
	...
	@Test
	void testGetRank() {
		Card c = Card.getCard(Rank.ACE, Suit.CLUBS);
	...
	void testCompareTo_Less() {
		...
		Card c2 = Card.getCard(Rank.KING, Suit.CLUBS);
	...
	void testCompareTo_Equal() {
		Card c1 = Card.getCard(Rank.ACE, Suit.CLUBS);
		Card c2 = Card.getCard(Rank.ACE, Suit.CLUBS);
	...
	void testEquals_NotEqualRank() {
		Card c1 = Card.getCard(Rank.ACE, Suit.CLUBS);
		Card c2 = Card.getCard(Rank.TWO, Suit.CLUBS);
	...
	void testEquals_NotEqualSuit() {
		Card c1 = Card.getCard(Rank.ACE, Suit.CLUBS);
		Card c2 = Card.getCard(Rank.ACE, Suit.HEARTS);
